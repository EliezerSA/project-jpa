 ...
 * 
 */
package com.buenmasttro.projectjpa.dao.impl;
...
/**
 * @author Eliezer Clase que implementa las transacciones para la tabla Disquera
 *
 */
public class DisqueraDAOImpl implements DisqueraDAO {
	...
	public Disquera consultarByDescripcionNative(String descripcion) {
		...
		TypedQuery<Disquera> queryDisquera = (TypedQuery<Disquera>) em.createNativeQuery("SELECT * FROM Disquera WHERE descripcion = :cielo");
